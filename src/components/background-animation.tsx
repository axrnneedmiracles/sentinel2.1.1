...
export function BackgroundAnimation() {
  ...
  return (
    <div className="fixed inset-0 -z-10 h-full w-full overflow-hidden bg-background">
      <div 
        className="absolute inset-0 h-full w-full opacity-10 transition-opacity duration-300"
        style={{
          background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px, hsla(var(--primary), 0.15), transparent 40%)`,
        }}
      ></div>
